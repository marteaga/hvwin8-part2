...
namespace Samples.HvMvc.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        // GET: /HVAccount/Details
        [Authorize]
        public ActionResult Details()
        {
            // redirects the user to the healthvault account management page
            WebApplicationUtilities.RedirectToShellUrl(System.Web.HttpContext.Current, "MANAGEACCOUNT");
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            else
            {
                ...
                var url = Request.Params["ReturnUrl"] == null ? (Request.UrlReferrer == null || Request.UrlReferrer.PathAndQuery == null ? "/" : Request.UrlReferrer.PathAndQuery) : Request.Params["ReturnUrl"];
        ...
        private void CreateAuthCookie(PersonInfo personInfo, MembershipUser user, string authToken)
        {
